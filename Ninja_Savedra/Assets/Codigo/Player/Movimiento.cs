...
public class Movimiento : MonoBehaviour
{
    ...
    void HandleJump()
    {
        if ((Input.GetKeyDown(KeyCode.Space) || Input.GetKeyDown(KeyCode.W) || Input.GetKeyDown(KeyCode.UpArrow)) && ActivarSalto.TocandoSuelo)
        {
    ...
    void AnimatePlayer()
    {
        ...
        if (ActivarSalto.TocandoSuelo)
        {
            ...
            animator.SetBool("Corriendo", horizontal > 0.5f);
        }
    }
